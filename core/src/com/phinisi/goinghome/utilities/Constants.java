...
public class Constants {
    ...
    public static short CharCategory = 0x0001;
    public static short MonsterCategory = 0x0002;
    public static short WallCategory = 0x0004;
    public static short PlatformCategory = 0x0008;
